...
int main(){
    ...
    int age[AGE_LENGTH]; 
    float temperature[] = {31.5, 32.7, 38.9}; //array of doubles, part of implicit conversions can be converted to float
    // Note that auto does not work for arrays, type MUST be specified.
    age[0] = 25;
    age[1] = 20;
    age[2] = 19;
    age[3] = 19;
